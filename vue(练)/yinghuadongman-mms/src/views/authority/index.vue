  ...
  <div>
    ...
    >
      <el-form-item prop="name">
        <el-input v-model="searchMap.name" placeholder="管理员名称" style="width:200px;"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="tableData" style="width: 100%" height="600" stripe border>
      ...
      <el-table-column prop="serial" label="管理员工号" width="100"></el-table-column>
      <el-table-column prop="cardNum" label="管理员账号"></el-table-column>
      <el-table-column prop="integral" label="管理员密码"></el-table-column>
      <el-table-column prop="birthday" label="管理员生日"></el-table-column>
    ...
    <!-- 对话框 -->
    <el-dialog :title="id ? '编辑管理员' : '添加管理员' " :visible.sync="dialogFormVisible" width="500px">
      <el-form
        status-icon
        ref="pojoForm"
        :model="pojo"
        ...
        style="width: 400px;"
      >
        <el-form-item label="管理员工号" prop="serial">
          <el-input v-model="pojo.serial" />
        </el-form-item>
        <el-form-item label="管理员名称" prop="name">
          <el-input v-model="pojo.name" />
        </el-form-item>
        <el-form-item label="管理员账号" prop="cardNum">
          <el-input v-model="pojo.cardNum" />
        </el-form-item>
        <el-form-item label="管理员密码" prop="integral">
          <el-input v-model="pojo.integral" />
        </el-form-item>
        ...
        <el-form-item prop="payType" label="管理员权限">
          <el-input v-model="pojo.payType" />
        </el-form-item>
      </el-form>
...
<script>
import memberApi from "@/api/authority";
...
export default {
  ...
  methods: {
    ...
    async getinquire() {
      try {
        let p = await memberApi.inquire(this.searchMap.name);
