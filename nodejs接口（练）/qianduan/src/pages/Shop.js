...
import Add_css from "../assets/css/Address_sel.module.scss";
 ...
 function Shop (props){
     ...
     let userGood = useCallback(()=>{ //已登录执行
        shopData.setShopCar({
            discount:shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].discount,
            price:shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].price,
            id:shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].id,
            goodName:shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].alias,
            goodImg:shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].imgsrc
        }).then(res=>{
            if(res.code == '2000'){
            ...
            <Spin  spinning = {loading}>
                    ...
                    <div className="inner-wrap">
                        <div className="product-box">
                            ...
                            <div className="product-box-price">
                                <div className="pd-price">
                                    <span>￥</span>
                                    <strong>{
                                        shop.typeSpecification[shopIndex.typeSpecification] ? shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].discount * shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].price : '加载中'
                                    }</strong>
                                </div>
                        ...
                        <div className="product-arguments">
                            <a onClick={()=>addressCh(true)}>
                                ...
                                <span className="text">
                                    {shop.typeSpecification[shopIndex.typeSpecification] ? shop.typeSpecification[shopIndex.typeSpecification].type_min + '/' + shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].alias : '加载中'}
                                </span>
                                        ...
                                        analogyShop.map((item,index)=>(
                                            <div className="item" key={index} onClick={()=>goOneShop(item.goods_id)}>
                                                ...
                                                <span className="price">
                                                    ￥
                                                    <span>{item.typeSpecification[0].specification[0].discount * item.typeSpecification[0].specification[0].price}</span>
                                                </span>
                                                    </div>
                                                </a>
                                            </div>
                        ...
                        <div className="pd-detail">
                            {
                                ...
                                shop.typeSpecification[shopIndex.typeSpecification] &&
                                shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].imgsrc ?
                                shop.typeSpecification[shopIndex.typeSpecification].specification[shopIndex.specification].imgsrc.split(',').map(item=>(
                ...
                >
                    <div>
                        ...
                        {
                            (shop.typeSpecification[shopIndex.typeSpecification] || {specification:[]}).specification.map((item,index)=>(
                                <span key={index} style={{
                                    display: 'inline-block',
                                    padding:'5px',
                                    border : '1px solid',
